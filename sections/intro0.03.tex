...
M31 has a similar age, stellar mass, and morphological type to the Milky Way. 
Both galaxies are located in the ``green valley'' area in the colour versus stellar mass diagram of galaxies, which indicate they both lost most of their cold gas and hence have a low star formation rate.
In general M31 is considered a typical galaxy that is in a transition state from a starburst galaxy to a quiescent one \citep{Mutch11}.
...
We apply the 2D trained networks to the M101 data to study whether they have similar properties to M31.
