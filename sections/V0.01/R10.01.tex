...
%         \end{figure}
        ...
        Regions that are located in similar areas in M31, like region 7 and 4 (see Fig.~\ref{fig: regions in m31}), are most likely to have more similarities to each other. %%present? show? represent? have?
