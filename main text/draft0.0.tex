...
\title{Mining in archival data of Nearby Galaxies}
...
\begin{abstract} 
 The vast availability of data for nearby galaxies makes them  suitable target for data mining  in order to ﬁnd new patterns in these galaxies.
In this project we are studying data from 10 regions in M31 and 8 regions in M101.Based on available information for these two galaxies we classified these regions in different groups  using self organizing map (SOM) method.
